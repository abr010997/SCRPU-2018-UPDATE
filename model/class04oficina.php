...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	private $PU42IDSERVIDUMBRE;
	private $PU42DESCRIPCION;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	public function buscarIngresoTraServidumbres($PU04IDTRA)
	{
		$sql = "CALL SP04_INGRESOTRAMITE_LISTAR_SERVIDUMBRES('".$PU04IDTRA."')";
		$result = $this->conexion->consultaRetorno($sql);
		$class04oficina = $this->convertToIngresoTraServidumbre($result);
		return $class04oficina;
	}
	//////////////////////
	public function convertToIngresoTraServidumbre($result)
	{
		$ACTSERVIDUMBRE = array();
		$i=0;
		while ($row = mysqli_fetch_array($result)) {
			$class04oficina = new class04oficina();
			//$class04oficina->setAtributo('PU04IDTRA',$row[0]);
			$class04oficina->setAtributo('PU42IDSERVIDUMBRE',$row[0]);		
			$class04oficina->setAtributo('PU42DESCRIPCION',$row[1]);
			$ACTSERVIDUMBRE[$i]=$class04oficina;
			$i++;
		}
		return $ACTSERVIDUMBRE;
	}
...
{
$sql = "call SP47_TRATIPOTRAMITE_GUARDAR('$this->PU04IDTRA','$this->PU47IDTIPOTRAMITE','$this->CONSECUTIVOTRAMITE');";
	$this->conexion->consultaSimple($sql);
