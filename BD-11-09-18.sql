...
MySQL - 5.5.5-10.1.35-MariaDB : Database - pu_ingenieria
*********************************************************************
*/
...
insert  into `pu06tracomercial`(`PU04IDTRA`,`PU06IDACTDES`) values (1,27),(4,11),(4,12),(123445,11),(123445,13),(2230,14),(2230,15),(30072018,15),(1153,13),(8585,14),(555,27),(62843,27),(2666,27),(27082018,12),(27082018,14),(63172,13),(63172,14);
...
insert  into `pu06tracomercial_industrial`(`PU04IDTRA`,`PU06IDACTDES`) values (1,28),(4,16),(4,17),(123445,16),(123445,17),(62135,17),(22530,28),(1153,16),(8585,28),(2666,17),(27082018,18),(63172,18);
...
insert  into `pu06traestacionservicios`(`PU04IDTRA`,`PU06IDACTDES`) values (1,19),(1,24),(4,19),(4,23),(123445,19),(123445,20),(1153,23),(8585,24),(62843,24),(2666,23),(27082018,23),(27082018,24),(63172,23);
...
insert  into `pu26planregtramite`(`PU04IDTRA`,`PU26IDPLAN`) values (1,1),(2,1),(3,1),(4,1),(60871,3),(123445,1),(62135,3),(22530,1),(2230,1),(2258,1),(5454,1),(8585,1),(2256,1),(30072018,1),(2377,1),(1153,2),(999,1),(555,1),(8960,1),(2666,3),(31072018,3),(63299,1),(182018,1),(62843,1),(61438,1),(63212,3),(63172,3),(67521,3),(27082018,1),(28082018,1);
...
insert  into `pu44traleyaccesos`(`pu04idtra`,`pu45idley`) values (1,13),(4,18),(60871,31),(22530,33),(30072018,31),(1153,31),(8585,31),(555,31),(62843,31),(2666,33),(27082018,13);
...
insert  into `pu46traleyareaspro`(`pu04idtra`,`pu45idley`) values (1,31),(4,31),(1153,9),(8585,9),(27082018,19),(2230,15);
...
insert  into `pu46traleyaspectobio`(`pu04idtra`,`pu45idley`) values (1,3),(62135,10),(60871,10),(22530,10),(30072018,10),(1153,10),(8585,10),(555,10),(62843,10),(27082018,10);
...
insert  into `pu46traleydesarrosect`(`pu04idtra`,`pu45idley`) values (1,12),(62135,1),(62135,2),(62135,23),(30072018,2),(1153,23),(27082018,23);
...
insert  into `pu46traleyespaciosgeo`(`pu04idtra`,`pu45idley`) values (1,12),(62135,22),(22530,22),(1153,22),(8585,22),(555,22),(62843,21),(2666,21),(182018,21),(27082018,21);
...
insert  into `pu46traleyplan`(`pu04idtra`,`pu45idley`) values (1,14),(4,14),(60871,24),(22530,24),(1153,25),(8585,24),(555,24),(27082018,11),(27082018,20),(27082018,25);
...
insert  into `pu46traleyservidumbres`(`pu04idtra`,`pu45idley`) values (60871,36);
