...
insert  into `pu04regtra`(`PU04IDTRA`,`PU04FETRA`,`PU04NORTE`,`PU04ESTE`,`PU04ALTITUD`) values (1,'2018-11-04 15:22:53',1,1,1),(4,'2018-11-04 16:10:29',123,123,123),(6497,'2018-11-04 16:21:49',234,565,434);
...
insert  into `pu04tramite1`(`PU04IDTRA`,`PU0INDICETRA`,`PU04FEINICIO`,`PUIDESTADO`) values (1,218,'2018-11-04 15:22:46',2),(2,219,'2018-11-05 15:37:49',2),(3,220,'2018-11-04 15:40:25',2),(4,221,'2018-11-04 16:10:19',7),(6497,222,'2018-11-04 16:21:40',7);
...
insert  into `pu04tramite2`(`PU04IDTRA`,`PU04FEPLATAFOR`,`PU04IDDISTRITO`) values (1,'2018-11-04 00:00:00',1),(4,'2018-11-04 00:00:00',1),(6497,'2018-11-14 00:00:00',1);
...
insert  into `pu06tracomercial`(`PU04IDTRA`,`PU06IDACTDES`) values (6497,14);
...
insert  into `pu06traresidencial`(`PU04IDTRA`,`PU06IDACTDES`) values (4,2),(6497,1);
...
insert  into `pu09tradeg`(`PU04IDTRA`,`PU09IDDEG`) values (1,1),(4,1),(6497,1);
...
insert  into `pu11uniabio`(`PU04IDTRA`,`PU10IDASBIO`) values (1,1),(4,1),(6497,4);
...
insert  into `pu12tratipdesec`(`PU04IDTRA`,`PU12IDTDESEC`) values (1,3),(4,1),(6497,3);
...
insert  into `pu14trarep`(`PU04IDTRA`,`PU13IDAAP`) values (1,5),(4,3),(4,4);
...
insert  into `pu22traserv`(`PU04IDTRA`,`PU22IDTREDV`) values (1,4),(4,2),(6497,5);
...
insert  into `pu25patent`(`PU04IDTRA`,`PU24IDINFR`) values (1,3),(4,1);
...
insert  into `pu26planregtramite`(`PU04IDTRA`,`PU26IDPLAN`) values (1,1),(4,1),(6497,1);
...
insert  into `pu26traplan`(`PU04IDTRA`,`PU26IDDESCNICOYASAMA`) values (1,1),(4,1),(6497,1);
...
insert  into `pu38traservidumbres`(`PU04IDTRA`,`PU38IDSERVIDUMBRE`) values (1,1),(4,1),(6497,5);
...
insert  into `pu39regsolicitante`(`PU39CEDSOLICI`,`PU39NOMSOLICI`,`PU39APE1SOLICI`,`PU39APE2SOLICI`) values ('111','Marilis','Alvarado','Rodriguez'),('123','Alberth','Esquivel','Alvarado');
...
insert  into `pu40propietarioterreno`(`PU40CEDPROPIE`,`PU40NFINCA`) values ('1234','Gm-123'),('456','asd'),('111','aaa'),('222','sss'),('504170844','5778-00'),('501710524','1097');
...
insert  into `pu40regpropietario`(`PU40CEDPROPIE`,`PU40NOMPROPIE`,`PU40APE1PROPIE`,`PU40APE2PROPIE`) values ('111','Marilis','Alvarado','Rodriguez'),('1234','Alberth.  ','Esquivel.  ','Alvarado.  '),('222','sss','sss','sss'),('456','Abraham','Obando','Villegas'),('501710524','Higinia','Villegas','Rosales'),('504170844','Josu̩','Obando','Villegas');
...
insert  into `pu40terreno`(`PU40NFINCA`,`PU40NCATASTRO`,`PU04IDDISTRITO`,`PU39BARRIO`,`PU39DIRECCION`) values ('1097','2345-2018',1,'Nicoya','1 km al este'),('5778-00','152025',1,'Nicoya','Nicoya'),('aaa','aaa',1,'aaa','aaa'),('asd','as123',2,'Nicoya','Nicoya'),('Gm-123','Awa345',1,'La virginia','300mts este de la plaza la pangola'),('sss','sss',1,'sss','sss');
...
insert  into `pu40tramitepropietarioterreno`(`PU04IDTRA`,`PU40CEDPROPIE`,`PU40NFINCA`) values (1,'1234','Gm-123'),(2,'111','aaa'),(3,'222','sss'),(4,'504170844','5778-00'),(6497,'501710524','1097');
...
insert  into `pu47tratipotramite`(`PU04IDTRA`,`PU04IDTIPOTRA`,`PU47IDCONSECUTIVO`) values (6497,0,'1011');
...
insert  into `putramitesolicitante`(`PU04IDTRA`,`PU39CEDSOLICI`) values (2,'111'),(3,'111'),(1,'123'),(4,'111'),(6497,'111');
