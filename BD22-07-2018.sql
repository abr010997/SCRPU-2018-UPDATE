...
(3,'Infraestructura de tipo residecial'),
(4,'No hay desarrollo en la zona');
...
(29,'Para: Cuando se deniega un uso de suelo.','De conformidad con lo expuesto en el artÃ¬culo 162 del cÃ³digo municipal, puede interponer los recursos de revocatoria con apelaciÃ³n en subsidio dentro de un plazo de los cinco dÃ¬as hÃ¡biles, contados a partir del dÃ¬a siguiente de la presente notificaciÃ³n, que resuelve el departamento de planificaciÃ³n urbana en revocatoria y el alcalde municipal en apelaciÃ³n subsidiaria, ello en caso de que se decida interponer uno o ambos recursos.',NULL),
...
(32,'Para: Cuando se marca Área Verde o Zona Institucional, y se deniega el uso de suelo.',' De previo a resolver favor presentar el HistÃ³rico de la finca desde su nacimiento. ',NULL),
