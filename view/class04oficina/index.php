<?php $result = $this->
class04oficina->listarTraRealizado(); ?>
<div class="container-fluid">
	<h2> Trámites en espera para Oficina</h2>
	<a href="?c=class04oficina&m=index2" class="btn btn-primary" role="button">Ver Trámites Oficina</a>
	<br>
	<br>
	<?php if ($result->
	num_rows): ?>
...
<?php echo $row[4]; ?>
		...
		<td>
			<div class="dropdown">
				...
				<ul class="dropdown-menu">
					<li>
					<a href="?c=class04oficina&m=agregar&id=<?php echo $row[0]; ?>"> <span class="glyphicon glyphicon-pencil"></span> Oficina</a>
					</li>
					<!-- <li>
	...
	<?php endwhile; ?>
	<?php else: ?>
	<div style="background-color: #0b7c3b" class="alert ">
		<center>
		<strong>¡Información!</strong> No hay información sobre trámites. </center>
	</div>
	<?php endif ?>
	</tbody>
	</table>
